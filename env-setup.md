...
{: .green }
Welcome to Practical Data Science in Winter 2025! This site is currently under construction, though if you happen to stumble upon this page, the Environment Setup instructions here are valid and you _can_ follow them if you'd like.
...
GitHub in [this Git repository](https://github.com/practicaldsc/wi25). This means that you'll need to download and use Git in order to work with the course
...
\"clone\" the course repository. The command to do this is:
    ...
    git clone https://github.com/practicaldsc/wi25
...
You might – but hopefully won't! – face issues when using `git pull` regarding merge issues and branches. This is caused by files being updated on your side while we are also changing the [Git repository](https://github.com/practicaldsc/wi25) by updating assignments on our side.
