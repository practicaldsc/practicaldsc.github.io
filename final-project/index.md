...
> - (Optional) custom dataset proposal due **Wednesday, June 4th**
> - [Checkpoint](#checkpoint-submission) due **Friday, June 6th** (slip days allowed!)
> - Final Submission due **Friday, June 20th** (<b><span style="color:red">no slip days allowed!</span>)
...
- There is a **checkpoint**, due June 6, 2025, worth 15 points out of the 100 points the project is scored out of. It exists to make sure you've picked a dataset and started some preliminary work. See the [Checkpoint Submission](#checkpoint-submission) section for more details and for the Gradescope submission link.
...
- As your final deliverables, you'll submit two things to us:
  - a public-facing website. We'll eventually create a public [Showcase](https://practicaldsc.org/showcase/) site that has links to everyone's submissions – **that is, your website will be available to the entire internet!**
...
{: .green }
> If you're interested in bringing your own dataset, the fourth page linked above will guide you through the process of proposing a custom dataset. Note that the deadline to propose a custom dataset is **Wednesday, June 4th**.
>
> Given the smaller enrollment this Spring term, we **strongly encourage** everyone to choose a custom dataset. This is because course staff will have the bandwidth to mentor you through your custom project, in ways that aren't usually possible in the Fall/Winter. Students who have selected custom datasets have reported feeling more satisfied with their projects, because they got to choose a topic they were passionate about.
>
> If you choose one of the default three options, choose the topic that you're most passionate about, as that'll make finishing the project easier and more fun!

{: .blue }
To help contextualize the kinds of analysis you can do in this project, it might help to browse through the [**Showcase Page**](https://practicaldsc.org/showcase/), with links to projects from Fall 2024 and Winter 2025. Treat previous terms' examples as foundations for inspiration, but **don't** just repeat or copy their work - be original!
...
1. Pull the latest version of the course GitHub repo, [github.com/practicaldsc/sp25](https://github.com/practicaldsc/sp25). Within the `final-project` folder, there is a `template.ipynb` notebook that you will use as a template for the project. If you delete the file or want another copy of the template, you can re-download it from [here](https://github.com/practicaldsc/sp25/blob/main/final-project/template.ipynb). This is where your analysis will live; you will submit this entire notebook to us.
...
| Step                       | Analysis in Notebook                                                                                                                                                                                                                                                                                                                                                                                       | Report on Website                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Problem Identification** | Identify a prediction problem. Feel free to use one of the example prediction problems stated in the "Example Questions and Prediction Problems" section of your dataset's description page or pose one of your own. The prediction problem you come up with doesn't have to be related to the question you were answering in Steps 1-2, but ideally, your entire project has some sort of coherent theme. | Clearly state your prediction problem and type (classification or regression). If you are building a classifier, make sure to state whether you are performing binary classification or multiclass classification. Report the response variable (i.e. the variable you are predicting) and why you chose it, the metric you are using to evaluate your model and why you chose it over other suitable metrics (e.g. accuracy vs. F1-score).<br><br>**_Note_**: There are really two reasons to build a model – **prediction** or **inference**. A predictive model is one in which you aim to predict some target variable, given features whose values you would realistically know **without** knowing the value of the target variable. For instance, if I wanted to predict your Final Project grade, it wouldn't make sense to use your Final Exam grade, because we won't have the Final Exam graded before the Final Project! On the other hand, an inferential model is one in which you aim to understand the relationship between features and the target variable. So, if my goal is to understand how different course assessments influence a student's Final Project score, it would be reasonable to use Final Exam scores. You should clarify if you're building a predictive or inferential model, and if you're building a predictive model, justify why you would know the features you're using at the time of prediction (e.g. make sure you're not using information "from the future"). Feel free to ask questions if you're not sure.  |
...
As mentioned at the top of this page, this project has a required checkpoint, worth **15 of the 100 points**. You can submit the checkpoint [**here on Gradescope**](https://www.gradescope.com/courses/1033440/assignments/6264705/). The checkpoint asks you to answer the following questions:
...
| **Step 2: Data Cleaning and Exploratory Data Analysis** <br>• Cleaned data (5 points)<br>• Performed univariate analyses (7.5 points)<br>• Performed bivariate analyses and aggregations (7.5 points) | 20 points      |
...
1. You should decide on your partnership as soon as possible, but certainly before the checkpoint deadline of June 6th, which you're required to submit in your partnerships.
