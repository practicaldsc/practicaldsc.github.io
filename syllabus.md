...
Refer to the [Fall 2024 course evaluations](../assets/marketing/fa24-evals.pdf) to see what students from Fall 2024 said about the course. Student perceptions of workload from Fall 2024 are shown below; we expect this offering's workload to be similar.
...
- **Ed:** We’ll be using Ed as our course message and discussion board. (Think of Ed as a replacement to Piazza.) More
  ...
  here](https://edstem.org/us/join/PeKj7Q).

- **Gradescope:** You’ll submit all assignments to
  [Gradescope](https://www.gradescope.com/courses/930446). This is where all of
...
environment for the course. Discussion 1, **held on Thursday, January 9th**, will be dedicated to making sure you've followed these steps.

### Forms

Please fill out the required [Welcome Survey](https://docs.google.com/forms/d/e/1FAIpQLSfwn5kPDKgrHlyypVlp0hl2WyTVifBnQ1OO_g9U56FlrFE6aQ/viewform) to tell us a bit more about your background and whether you need an alternate exam **no later than Wednesday, January 15th**.
...
repository, [github.com/practicaldsc/wn25](https://github.com/practicaldsc/wn25); instructions on how to do this are in the [⚙️ Environment Setup](../env-setup) page. We will also link HTML previews of each lecture notebook from the course
...
There are four discussion sections on Thursdays. Their times and locations can be found on the [Calendar](../calendar) tab of the course website. **You can attend any discussion session, but if space fills up, priority will be given to students officially enrolled in that section.**
...
We appreciate any and all feedback, given that this course is new and evolving. If you'd like to provide us with anonymous feedback at any point, you can do so at [this form](https://docs.google.com/forms/d/e/1FAIpQLScjlYueonz7_ye6NtyIwdboOuQniPPxcCjsoRfjB4rPKDxKRg/viewform). Thank you!